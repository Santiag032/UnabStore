...
@Composable
fun RegisterScreen(onClickBack :() -> Unit = {}, onSuccessfulRegiter: () -> Unit = {}) {
    ...
    var inputPassowordConfirmation by remember{ mutableStateOf("") }
    ...
    Scaffold(
        ...
        Column(
            ...
            OutlinedTextField(
                value = inputPassowordConfirmation,
                onValueChange = {inputPassowordConfirmation = it},
            ...
            Button(
                onClick = {
                    ...
                    val isvalidConfirmPassword = validateConfirmPassword(inputPassword,inputPassowordConfirmation).first

                    nameError = validateName(inputName).second
                    emailError = validateEmail(inputEmail).second
                    passwordError = validatePassword(inputPassword).second
                    passwordConfirmationError = validateConfirmPassword(inputPassword, inputPassowordConfirmation).second
